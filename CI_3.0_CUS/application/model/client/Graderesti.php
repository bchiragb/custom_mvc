...
class graderesti extends Public_Controller {
  ...
  public function index() {
    $data                = array();
    $data['title']       = 'Grader Estimation - Admin Panel';
    $data['js']          = array();
    $data['jse']         = array();
    $data['djs']         = array();
    $data['css']         = array(
    ...
    $this->load->view('client/graderesti');
  ...
  public function add() {
    ...
    $this->load->view('client/navbar');
    $this->load->view('client/sidebar');
    $this->load->view('client/graderesti_add');
  ...
  public function edit() {
    ...
    $this->load->view('client/navbar');
    $this->load->view('client/sidebar');
    $this->load->view('client/graderesti_edit');
