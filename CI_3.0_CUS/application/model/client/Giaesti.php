...
class giaesti extends Public_Controller {
  ...
  public function index() {
    $data                = array();
    $data['title']       = 'GIA Estimation - Admin Panel';
    $data['js']          = array();
    $data['jse']         = array();
    $data['djs']         = array();
    $data['css']         = array(
  ...
  public function add() {
    ...
    $this->load->view('client/navbar');
    $this->load->view('client/sidebar');
    $this->load->view('client/giaesti_add');
  ...
  public function edit() {
    ...
    $this->load->view('client/navbar');
    $this->load->view('client/sidebar');
    $this->load->view('client/giaesti_edit');
